        ...
        >
          <nav className="flex flex-col items-center gap-8">
            ...
            <motion.button
              ...
              className="mt-4 px-8 py-4 bg-gradient-to-r from-accent-gold to-accent-gold-light text-primary font-semibold rounded-full text-sm tracking-[0.15em] uppercase cursor-pointer border-none"
            >
              Reserve a Table
            </motion.button>
          </nav>
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-20">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          onClick={() => scrollToSection('#reservation')}
          className="hidden lg:block px-6 py-2.5 border border-accent-gold/40 rounded-full text-xs tracking-[0.15em] uppercase text-accent-gold hover:bg-accent-gold/10 hover:border-accent-gold/70 transition-all duration-300 cursor-pointer bg-transparent font-body"
        >
          Reserve
        </motion.button>
        ...
        <button
          ...
          className="lg:hidden flex flex-col gap-1.5 cursor-pointer bg-transparent border-none p-2 z-50 relative"
