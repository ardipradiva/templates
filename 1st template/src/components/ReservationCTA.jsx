    ...
    <section id="reservation" className="section-padding relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <SectionReveal delay={0.1}>
          <h2 className="font-display text-4xl sm:text-5xl lg:text-7xl font-medium leading-[1.05] mt-6 mb-8">
            Your Table{' '}
        ...
        <SectionReveal delay={0.2}>
          <p className="text-text-muted text-base sm:text-lg max-w-xl mx-auto font-body font-light leading-relaxed mb-12">
        ...
        <SectionReveal delay={0.3}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <MagneticButton variant="primary" className="text-base px-10 py-5">
              Reserve Now
            </MagneticButton>
            <MagneticButton variant="secondary" className="text-base px-10 py-5">
              Contact Us
            </MagneticButton>
          </div>
        </SectionReveal>
